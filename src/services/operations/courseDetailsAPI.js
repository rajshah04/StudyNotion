...
const { COURSE_DETAILS_API, COURSE_CATEGORIES_API, GET_ALL_COURSE_API, CREATE_COURSE_API, EDIT_COURSE_API, CREATE_SECTION_API, CREATE_SUBSECTION_API, UPDATE_SECTION_API, UPDATE_SUBSECTION_API, DELETE_SECTION_API, DELETE_SUBSECTION_API, GET_ALL_INSTRUCTOR_COURSES_API, DELETE_COURSE_API, GET_FULL_COURSE_DETAILS_AUTHENTICATED, CREATE_RATING_API, LECTURE_COMPLETION_API,
} = courseEndpoints ;
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    // console.log("RESULT in courseDetails API : ", result) ;
  } catch (err) {
...
export const getFullDetailsOfCourse = async (courseId, token) => {
  ...
  try {
    ...
    console.log("COURSE_FULL_DETAILS_API API ERROR............", err) ;
    result = err.response.data ;
