...
import CourseEnrollments from "./components/core/Dashboard/Courses/CourseEnrollments";
      ...
      <Routes>
...

        {
          user?.accountType === ACCOUNT_TYPE.INSTRUCTOR && (
            <>
              <Route path="/dashboard/instructor-dashboard" element={<Instructor />} />
        ...
        <Route path="/instructor/:instructorName" element={<InstructorDetails />} />
